...
// Full-width quote band under the hero — the ink band between the light hero
// and the category tiles (homeTagline module).
  ...
  return (
    <section className="bg-ink text-bone">
      <div className="mx-auto max-w-[1400px] px-6 md:px-10 py-16 md:py-24 text-center">
        ...
        {subline && (
          <p className="mt-5 label-eyebrow !text-cream opacity-70">
            {subline}
          </p>
        )}
      </div>
