...
const seeds: SeedPost[] = [
  {
    ...
    title: "Shaman Stories: A Return to the Elements",
    excerpt:
      "Episode 01 — The Origin. Not a narrative of belief, but an invitation to experience. In metal. In seed. In air. In earth. In water. Shakti lives within it all.",
...
For centuries, we've searched for answers outside — only to realise they were always within nature.
